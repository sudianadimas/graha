...
(1, 'A1-1', 'KOSONG', '', '', '', '', ''),
(2, 'A1-2', 'Triyono Jedul', 'boy', '2023-12-19', 'X', 'X', 'X'),
(3, 'A1-3', 'Erdi Wishnu', 'boy', '2023-12-19', 'X', 'X', 'X'),
(4, 'A1-4', 'Tiara', 'boy', '2023-12-19', 'X', 'X', 'X'),
(5, 'A1-5', 'Ade aditya Yahdjan', 'boy', '2023-12-19', 'X', 'X', 'X'),
...
(199, 'C3-18', 'Ahmad Sudiana (Dana)', 'boy', '1959-07-25', 'AYAH', '085965913990', 'WARGA TETAP'),
(200, 'C3-19', 'A Bondan Sasongko', '', '', '', '', ''),
(201, 'C3-20', 'Andrey', '', '', '', '', ''),
(202, 'C3-21', 'Syamsul Arief', 'boy', '2023-12-20', 'suami', '999999', 'warga tetap'),
(203, 'C3-22', 'Wawan', '', '', '', '', ''),
